    ...
    public class Utils
    {
        ...
        public static void LoadVendedor(ref SAPbouiCOM.ComboBox oComboBox)
        {
            ...
            if (oComboBox != null)
            {
                ...
                listObject = Forxap.Framework.DI.Sb1Users.GetListFromSQL("CALL SP_VIS_PERSON_POSITION ('VENDEDOR') ");
                foreach (var item in listObject)
                {
        ...
        public static void LoadBancos(ref SAPbouiCOM.ComboBox oComboBox)
        {
            ...
            Forxap.Framework.DI.Bancos.Banks.GetBankList(ref oComboBox);
        ...
        /// <param name="oComboBox"></param>
        /// <param name="tableID"></param> 
        public static void LoadCuentas(ref SAPbouiCOM.ComboBox oComboBox , string bankCode)
        {

           // Forxap.Framework.DI.Bancos.Banks.GetAccountList(ref oComboBox, bankCode);
        ...
        public static void LoadEstadoo(ref SAPbouiCOM.ComboBox oComboBox)
        {
            ...
            if (oComboBox != null)
            {
                ...
                listObject = Forxap.Framework.DI.Sb1Users.GetListFromSQL("CALL d() ");
                foreach (var item in listObject)
                {
                    oComboBox.ValidValues.Add(item.Key, item.Value);
                }
        ...
        public static void LoadSupervisor(ref SAPbouiCOM.ComboBox oComboBox)
        {
            ...
            if (oComboBox != null)
            {
                ...
                listObject = Forxap.Framework.DI.Sb1Users.GetListFromSQL("CALL SP_VIS_PERSON_POSITION ('SUPERVISOR') ");
                foreach (var item in listObject)
                {
                    oComboBox.ValidValues.Add(item.Key, item.Value);
                }
