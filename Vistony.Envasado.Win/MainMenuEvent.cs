   ...
   public  class MainMenuEvent
    {
       ...
       static SAPbouiCOM.Form oForm;
                ...
                if (pVal.BeforeAction)
                {
                    switch (pVal.MenuUID)
                    {
                       /* #region Modulos/Distribucion 
                        ...
                        case AddonMenuItem.Evaluacion_Rentabilidad:
                            {
                                OnShowEvaluacionRentabilidadReparto();
                            }
                            break;
        ...
        private  void OnShowEvaluacionRentabilidadReparto()
        {
            try
            {
               // WzbEvaluacion_Rentabilidad form1 = new WzbEvaluacion_Rentabilidad();
              //  form1.Show();
            }
            catch (Exception ex)
            {
